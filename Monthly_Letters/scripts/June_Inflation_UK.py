...
def make_rates_chart(save=False):
    # Data manipulation
    ...
    with plt.style.context(style):
        ...
        # Add in title and subtitle
        ax.text(x=0.05, y=.93, s="Bank of England Rate", transform=fig.transFigure, ha='left', fontsize=12,
                weight='bold',
                alpha=.9)
